...
--	properties are new and mandatory. For each property there is a default value defined. This	--
--	script creates the relevant missing mandatory properties records for all the organizations.	--
--													--
-- Script methodology:											--
...
--	   Groups to the properties table. Meta groups has a list of groups with properties.		--
...
--	   properties of the organizations and then removing the existing properties			--
--	4. Inserting the missing properties with the default value defined for each property		--
--	5. Cleanup											--
--													--
-- Updates Tacking:											--
-- 03-May-2004: 											--
--	** Added: Track script actions to log.								--
--	** Added: Version control documentation. 							--
--	** Update properties to all organizations. previously only active organizations properties  	--
--	   were updated. 										--
--													--
--													--
----------------------------------------------------------------------------------------------------------
set echo on
-- spool  DBScript1-7-12-4-1.log

INSERT INTO ARCH_VERSION ( TIMESTAMP, VERSION, DESCRIPTION, LOGFILE, SOLUTION_VERSION )
	VALUES (sysdate , '1.7.12.4::1', 'jpmc 1.7 stf 12.4 (Properties update)', '/Arch2.0/installationLog/databaseInstall.log', '1.7.12.4::1');
...
WHERE 
	...
	flat.object_type     = 1000 and             /* get organizations only	*/ 
	props.required       = 1                    /* Mandatory props only  	*/ 
MINUS -- Existing properties 
SELECT 
	 OBJECT_ID  , 
	 OBJECT_TYPE, 
	 CODE_ID 
...
-----------------------------------------------------------
-- STEP 4: Insert raws of missing properties
-----------------------------------------------------------
-- Insert defualt values for all missing properties 
