...
export SEND_TO=ms-dba@traiana.com,nirb@traiana.com;noc2@traiana.com
export RC=0
...
REPORT_NAME=`sqlplus -s -L sm/sm@monp <<!EOF
set HEADING OFF
set feedback off
set ECHO OFF
...
sqlplus sm/sm @/oracle/sundaymaint/dumphtml.sql $REPORT_NAME $SPOOL_FILE_NAME 
