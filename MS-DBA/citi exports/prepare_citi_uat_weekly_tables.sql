...
create table A_TA as select * from A_TA@citi_uat;

create table A_OA as select * from A_OA@citi_uat;

create table M_FX_NOE as select * from M_FX_NOE@citi_uat;

create table A_TA_TA_REL as select * from A_TA_TA_REL@citi_uat;

create table M_FX_OPTION_NOE as select * from M_FX_OPTION_NOE@citi_uat;
...
create table A_TA_HIS as select * from A_TA_HIS@citi_uat;

create table M_FX_NOE_HIS as select * from M_FX_NOE_HIS@citi_uat;

create table A_TA_TA_REL_HIS as select * from A_TA_TA_REL_HIS@citi_uat;

create table A_VAL_MD_CURRENCY_HIS as select * from A_VAL_MD_CURRENCY_HIS@citi_uat;

create table M_FX_OPTION_NOE_HIS as select * from M_FX_OPTION_NOE_HIS@citi_uat;

create table A_OA_HIS as select * from A_OA_HIS@citi_uat;
