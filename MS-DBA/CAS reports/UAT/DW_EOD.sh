...
setenv OUTPUT_PATH  /usr/local/traiana/CASFiles/UAT/DW_EOD/
...
#
#/usr/local/ebs/ebs --decrypt /ftp_home/Test/sFTP_Users/CAS.Tst.CLS/TAMI/CAS_EOD_DW_Report_11-17-2009_07-47.csv.pgp --output test.csv
