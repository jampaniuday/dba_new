...
FROM cas_uat.MSG_QUEUE_IN Q_IN
JOIN cas_uat.MSG_QUEUE_OUT Q_OUT ON (Q_IN.TXN_ID=Q_OUT.TXN_ID)
JOIN cas_uat.FD_FXPB_LINEAR_TA TA ON (Q_IN.TXN_ID=TA.TXN_ID)
JOIN cas_uat.A_ORGANIZATION ORG ON (TA.TP_ID=ORG.ID)
