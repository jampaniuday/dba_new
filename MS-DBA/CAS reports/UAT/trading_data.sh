...
export ORIG_OUTPUT_PATH=`date +"/cassrc/reports/uat/trading_data_UAT_%d-%m-%Y_%H-%M.csv"`
export ORIG_OUTPUT_FILE_NAME=`date +"trading_data_UAT_%d-%m-%Y_%H-%M.csv"`
export SPLIT_FILE_NAME=`date +"trading_data_UAT_%d-%m-%Y_%H-%M"`
export SPLIT_FILE_LOOP=`date +"trading_data_UAT_%d-%m-%Y_%H-%M0*"`
