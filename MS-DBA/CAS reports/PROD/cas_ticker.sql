...
SET DEFINE "^"
set pau off pages 1000 feed off
...
compute sum LABEL 'Total CAS PROD Blocks:' of "Total" "Regular" "Position" "Offset" "Aggregation" on report
break on report
spool ^1
select Trading_party "Trading party",Regular "Regular",Position "Position",Offset "Offset",Aggregation "Aggregation",Total "Total" from cas_tickets;
spool off
exit;
